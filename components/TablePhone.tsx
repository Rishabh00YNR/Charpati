...
const SEATS = [
  { name: 'Ritesh', gem: GEMS.emerald, ax: 40, ay: 300, gx: 72, gy: 265, next: true },
  { name: 'Chirag', gem: GEMS.amethyst, ax: 118, ay: 95, gx: 89, gy: 142 },
  { name: 'Arnav', gem: GEMS.ruby, ax: 272, ay: 95, gx: 243, gy: 142 },
  { name: 'Komal', gem: GEMS.sapphire, ax: 350, ay: 300, gx: 259, gy: 265 },
];
...
export default function TablePhone() {
  return (
    <div className="phone" role="img" aria-label="The Charpati table on a phone: you sit at the bottom with four face-down cards, Ritesh, Chirag, Arnav and Komal sit around a purple table, and the draw pile glows because it is your turn.">
      <div className="phone-screen">
        <div className="stage" aria-hidden="true">
          ...
          <div className="st-ticker" style={at(50, 232)}><i style={{ background: GEMS.sapphire }} />Komal swapped card 3 and threw away 9♠&#xFE0E;</div>
